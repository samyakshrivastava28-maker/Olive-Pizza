...
export default function PizzaLoader({ message = 'Baking your experience...' }: PizzaLoaderProps) {
  return (
    <div className="fixed inset-0 z-[100] backdrop-blur-md bg-black/40 flex flex-col items-center justify-center">
