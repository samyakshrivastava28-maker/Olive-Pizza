...
function ProductSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 animate-pulse">
      <div className="rounded-3xl bg-dark-900/60 min-h-[400px] lg:min-h-[600px]" />
      <div className="flex flex-col space-y-8 py-8">
        <div className="h-12 bg-dark-800 rounded w-3/4" />
        <div className="h-6 bg-dark-800 rounded w-full" />
        <div className="h-6 bg-dark-800 rounded w-5/6" />
...
export default function ProductDetail() {
  ...
  // 3D Interaction State (Framer Motion values to prevent re-renders)
  ...
  return (
    <>
      <SEO 
        ...
        image={item.image}
        schemaMarkup={generateProductSchema(item)}
      />
      <PageTransition className="max-w-7xl mx-auto p-4 md:p-8 min-h-[calc(100vh-80px)]">
        {/* Back Button */}
        <button
