...
const posDir = 'C:\\Users\\RYZEN\\Downloads\\olive-pizza-pos';
...
function writeFile(filePath, content) {
  const fullPath = path.join(posDir, filePath);
  ensureDir(path.dirname(fullPath));
  fs.writeFileSync(fullPath, content.trim(), 'utf8');
  console.log(`[POS Enhanced] ${filePath}`);
}
...
{
  "short_name": "Olive POS",
  "name": "Olive Pizza Restaurant Billing POS",
  "icons": [
    {
      "src": "/favicon.svg",
      "type": "image/svg+xml",
...
// 5. POSTerminalActivationPage.tsx
writeFile('src/pages/POSTerminalActivationPage.tsx', `
...
console.log('✅ Olive Pizza POS Enhanced successfully.');
